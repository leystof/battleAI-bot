...
exports.generateImagePrompt = void 0;
const index_1 = require("../../services/openai/index");
const logger_1 = require("../../utils/logger");
async function generateImagePrompt() {
    try {
        const { text } = await index_1.AI.aiGenerateText({
            model: index_1.AI.client("gpt-4o"),
...
Generate a completely unique prompt now:`,
        ...
        logger_1.log.error("Error generating image prompt: ", error);
